...
* [[#erd-diagram]]: moderatiestatus en afkeurreden op Media, rollen via een aparte koppeltabel
...
* [[#api-beschrijving]]: gesplitst in een publieke lees-API (`openapi.yaml`) en een beheer-API
    (`openapi-beheer.yaml`).
