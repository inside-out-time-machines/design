...
Per output bevat het document een veld→bron-tabel als **outputcontrole**: is alle data die aan de outputkant nodig is beschikbaar in de eerdere lagen (PostgreSQL, Object Storage, annotatieserver)? De daarbij gevonden hiaten zijn verwerkt in het ERD.
